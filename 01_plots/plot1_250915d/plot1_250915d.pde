...
line(1056, 264, 1230, 264); // Line from (1056, 264) to (1230, 264)
line(612, -545, 612, 0); // Line from (612, -545) to (612, 264)
line(1056, 324, 1170, 324); // Line from (1056, 324) to (1170, 324)
line(540, -540, 540, 0); // Line from (540, -540) to (540, 264)
line(1056, 396, 1100, 396); // Line from (1056, 396) to (1100, 396)
line(510, -510, 510, 0); // Line from (510, -510) to (510, 264)
line(1056, 426, 1070, 426); // Line from (1056, 426) to (1070, 426)
line(496, -495, 496, 0); // Line from (496, -495) to (496, 264)
line(1056, 440, 1055, 440); // Line from (1056, 440) to (1055, 440)
line(476, -480, 476, 0); // Line from (476, -480) to (476, 264)
line(1056, 460, 1035, 460); // Line from (1056, 460) to (1035, 460)
